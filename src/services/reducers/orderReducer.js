import { ORDER_GET_ORDER_NUMBER_SUCCESS, ORDER_GET_ORDER_NUMBER_FAILURE, IN_MODAL_OPEN_ORDER_CARD, SET_CURRENT_HISTORY_ORDER } from '../types';
...
export const currentOrderReducer = (state = historyOrderState, action) => {
  // const total = action.ingredients.reduce() - дописать
  const total = 'test';
  switch (action.type) {
